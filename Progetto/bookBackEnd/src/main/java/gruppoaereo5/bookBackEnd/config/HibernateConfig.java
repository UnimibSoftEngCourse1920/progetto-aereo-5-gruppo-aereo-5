...
@Configuration
@ComponentScan(basePackages= {"gruppoaereo5.bookBackEnd.dto"})
...
public class HibernateConfig {
	...
	private final static String DATABASE_PASSWORD ="progetto";
	
	@Bean("dataSource")
	public DataSource getDataSource() {
		BasicDataSource dataSource = new BasicDataSource();
		
		//fornisce informazioni per il collegamento al DB
	...
	//metodo che ritorna tutte le HibernateProperties
